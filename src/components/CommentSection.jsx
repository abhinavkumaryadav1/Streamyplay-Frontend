  ...
  return (
    <div className="mt-6">
      ...
      <div className="flex items-center gap-6 mb-6">
        <h3 className="text-lg font-bold text-gray-900 dark:text-white">{totalComments} Comments</h3>
      </div>
      ...
      <div className="flex gap-3 mb-6">
        ...
        <form onSubmit={handleSubmit} className="flex-1">
          <input
            ...
            className="w-full border-b border-gray-300 dark:border-gray-600 focus:border-gray-900 dark:focus:border-white outline-none py-2 text-sm bg-transparent transition text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
          />
          {isFocused && userData && (
            <div className="flex justify-end gap-2 mt-3">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition"
              >
                Cancel
              </button>
              <button
